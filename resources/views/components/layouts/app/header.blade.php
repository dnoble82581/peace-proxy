    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:header class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <a href="{{ route('dashboard') }}" class="ms-2 me-5 flex items-center space-x-2 rtl:space-x-reverse lg:ms-0" wire:navigate>
                <x-logos.full-logo-icon primary-size="text-xl" secondary-size="text-xs" />
            </a>
            ...
            <flux:navbar class="-mb-px ml-8 max-lg:hidden">
                ...
                <flux:navbar.item icon="archive-box-arrow-down" :href="route('negotiations')" :current="request()->routeIs('negotiations')" wire:navigate>
                    {{ __('Negotiations') }}
                </flux:navbar.item>
