@props(['header' => 'User Form', 'description' => 'Form Description', 'submit' => 'save', 'actions' => '', 'description_classes' => ''])
<form
	...
	<div class="px-4 border-b border-gray-200 bg-gray-50 dark-light-text dark:bg-gray-800">
		<h3 class="text-base font-semibold dark-light-text py-2">
			{{ $header }}
			<p class="mt-2 text-sm dark-light-text font-normal {{ $description_classes }}">{{ $description }}</p>
		</h3>
	</div>
