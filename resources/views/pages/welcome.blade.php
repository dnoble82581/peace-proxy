	...
	<div class="relative isolate pt-14">
		...
		<div class="py-24 sm:py-32 lg:pb-40">
			<div class="mx-auto max-w-7xl px-6 lg:px-8">
				...
				<img
						src="https://peace-proxy-public.s3.us-east-1.amazonaws.com/Assets/Screenshot+2025-02-04+at+12.57.37%E2%80%AFAM.png"
						alt="App screenshot"
						width="2432"
						height="1442"
...
<div class="overflow-hidden bg-gray-900 py-24 sm:py-32">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
			<div class="lg:pr-8 lg:pt-4">
				<div class="lg:max-w-lg">
					...
					<p class="mt-6 text-lg/8 text-gray-300">Lorem ipsum, dolor sit amet consectetur adipisicing elit.
					                                        ...
					                                        cupiditate blanditiis ratione.</p>
			...
			<img
					src="https://peace-proxy-public.s3.us-east-1.amazonaws.com/Assets/Screenshot+2025-02-04+at+12.58.22%E2%80%AFAM.png"
		...
		<div class="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
			...
			<div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
				<h2 class="text-balance text-3xl font-semibold tracking-tight text-white sm:text-4xl">Boost your
				                                                                                      ...
				                                                                                      Start using our
				                                                                                      app today.</h2>
				<p class="mt-6 text-pretty text-lg/8 text-gray-300">Ac euismod vel sit maecenas id pellentesque eu sed
			...
			<div class="relative mt-16 h-80 lg:mt-8">
				<img
						...
						src="https://peace-proxy-public.s3.us-east-1.amazonaws.com/Assets/Screenshot+2025-02-04+at+12.59.08%E2%80%AFAM.png"
						alt="App screenshot"
						width="1824"
						height="1080">
			</div>
		...
		<div class="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
			<div class="lg:pr-4">
				<div class="lg:max-w-lg">
					...
					<h1 class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">A
					                                                                                             better
					                                                                                             workflow</h1>
		...
		<div class="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
			<div class="lg:pr-4">
				<div class="max-w-xl text-base/7 text-gray-700 lg:max-w-lg">
					...
					<ul
							role="list"
							class="mt-8 space-y-8 text-gray-600">
						<li class="flex gap-x-3">
							<svg
					...
					<p class="mt-6">Id orci tellus laoreet id ac. Dolor, aenean leo, ac etiam consequat in. Convallis
					                ...
					                ipsum eu a sed convallis diam.</p>
				</div>
			</div>
		</div>
	</div>
